const VERIFY_EMAIL_TEMPLATE = (name: string, link: string) => {
  return `
                                    ...
                                    <tr>
                                      <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                        <a href="/" target="_blank">
                                          <img align="center" border="0" src="https://res.cloudinary.com/dc4li3m0r/image/upload/v1724951238/ooajkoqb8rcn0f9f6xxt.png" alt="Sateeq Logo" title="Sateeq Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 19%;max-width: 106.4px;"
                                            width="106.4" />
                                        </a>
                                      </td>
                                    </tr>
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:55px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div style="color: #ffffff; line-height: 140%; text-align: left; word-wrap: break-word;">
                                    ...
                                    <p style="font-size: 14px; line-height: 140%; color: #000000">Thanks for Join use Please Verify Your Email </p>
                                    <br /> <br />
                                    <p style="font-size: 14px; line-height: 140%; text-align: center;">
                                      <span style="color: #000000; line-height: 19.6px;">
                                        Link for verification is below.
                                      </span>
                                      <br />
                                      <!-- Centering the button with a wrapper -->
                                      ...
                                      <br /><br />
                                      <span style="color: #000000; line-height: 19.6px;">
                                        Note: This link is valid for the next 10 minutes.
                                      </span>  
                                      <br />
                                      <span style="color: #000000; line-height: 19.6px;">
                                        In case of Link not working <a href=${link}>${link}</a>
                                      </span>
                                    </p>

                                    <p style="font-size: 14px; line-height: 140%;"><br /><br /><span style="color: #000000; line-height: 19.6px;">Thanks &amp; Regards</span><br /><span style="color: #000000; line-height: 19.6px;">Team PLYPICKER</span></p>
                                  </div>
                              ...
                              <tr>
                                <td style="overflow-wrap:break-word;word-break:break-word;padding:48px;font-family:'Cabin',sans-serif;" align="left">
                                  ...
                                  <div style="color: #958d8d; line-height: 170%; text-align: center; word-wrap: break-word;">
                                    <p style="font-size: 14px; line-height: 170%;">Love 💙 Team PLYPICKER</p>
